...
#define fpin 12
#define minf 50        //max. feuchtigkeit
#define maxf 200.0 //min. feuchtigkeit 
...
void do_send(osjob_t* j){
  ...
  if (LMIC.opmode & OP_TXRXPEND) {
    ...
    unsigned int f = (unsigned int)(frequenzfeutigkeit);
